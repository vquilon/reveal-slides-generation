	...
	*/
	...
	var initializeCharts = function(){
		...
		for (var i = 0; i < canvases.length; i++ ){
			...
			if (canvases[i].hasAttribute("data-chart-url")) {
				preprocess_fn = window[canvases[i].getAttribute("data-chart-preprocess-fn")];
				createChartFromURL(canvases[i], preprocess_fn);
