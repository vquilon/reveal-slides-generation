! function(t, e) {
    ...
    function l(t, e) {
        if (e) {
            if (n.test(t)) return t.replace(s, o)
        } else if (i.test(t)) return t.replace(r, o);
        return t
    }
    ...
    function d(t, e) {
        ...
        const n = {
            replace: (e, s) => (s = (s = s.source || s).replace(u, "$1"), t = t.replace(e, s), n),
    ...
    function m(t, e, n) {
        ...
        e && !g.test(n) && (n = function(t, e) {
            ...
            t = f[" " + t];
            const n = -1 === t.indexOf(":");
            return "//" === e.substring(0, 2) ? n ? e : t.replace(x, "$1") + e : "/" === e.charAt(0) ? n ? e : t.replace(b, "$1") + e : t + e
        }(e, n));
        try {
    ...
    class _ {
        ...
        list(t) {
            ...
            if (e) {
                let n, s, i, r, a, o, l, c, p, u, d, h, g = e[1].trim();
                const m = g.length > 1,
                    f = {
                        type: "list",
                        raw: "",
                ...
                for (; t && (h = !1, e = k.exec(t)) && !this.rules.block.hr.test(t);) {
                    if (n = e[0], t = t.substring(n.length), c = e[2].split("\n", 1)[0].replace(/^\t+/, (t => " ".repeat(3 * t.length))), p = t.split("\n", 1)[0], this.options.pedantic ? (r = 2, d = c.trimLeft()) : (r = e[2].search(/[^ ]/), r = r > 4 ? 1 : r, d = c.slice(r), r += e[1].length), o = !1, !c && /^ *$/.test(p) && (n += p + "\n", t = t.substring(p.length + 1), h = !0), !h) {
                        ...
                        for (; t && (u = t.split("\n", 1)[0], p = u, this.options.pedantic && (p = p.replace(/^ {1,4}(?=( {4})*[^ ])/g, "  ")), !i.test(p)) && !a.test(p) && !e.test(p) && !s.test(t);) {
                    ...
                    f.loose || (l ? f.loose = !0 : /\n *\n *$/.test(n) && (l = !0)), this.options.gfm && (s = /^\[[ xX]\] /.exec(d), s && (i = "[ ] " !== s[0], d = d.replace(/^\[[ xX]\] +/, ""))), f.items.push({
                        type: "list_item",
                        raw: n,
                        task: !!s,
                        checked: i,
                ...
                for (a = 0; a < x; a++)
                    ...
                    for (a = 0; a < x; a++) f.items[a].loose = !0;
                return f
            }
        }
        html(t) {
        ...
        table(t) {
            ...
            if (e) {
                ...
                if (t.header.length === t.align.length) {
                    t.raw = e[0];
                    let n, s, i, r, a = t.align.length;
                    for (n = 0; n < a; n++) /^ *-+: *$/.test(t.align[n]) ? t.align[n] = "right" : /^ *:-+: *$/.test(t.align[n]) ? t.align[n] = "center" : /^ *:-+ *$/.test(t.align[n]) ? t.align[n] = "left" : t.align[n] = null;
                    for (a = t.rows.length, n = 0; n < a; n++) t.rows[n] = y(t.rows[n], t.header.length).map((t => ({
                        text: t
                    })));
                    for (a = t.header.length, s = 0; s < a; s++) t.header[s].tokens = this.lexer.inline(t.header[s].text);
                    for (a = t.rows.length, s = 0; s < a; s++)
                        for (r = t.rows[s], i = 0; i < r.length; i++) r[i].tokens = this.lexer.inline(r[i].text);
                    return t
                }
            }
        }
        ...
        link(t) {
            ...
            if (e) {
                ...
                return n = n.trim(), /^</.test(n) && (n = this.options.pedantic && !/>$/.test(t) ? n.slice(1) : n.slice(1, -1)), T(e, {
        ...
        emStrong(t, e, n = "") {
            ...
            if (!i || i && ("" === n || this.rules.inline.punctuation.exec(n))) {
                ...
                for (l.lastIndex = 0, e = e.slice(-1 * t.length + n); null != (s = l.exec(e));) {
                    ...
                    if (a -= r, a > 0) continue;
                    r = Math.min(r, r + a + o);
                    const e = t.slice(0, n + s.index + (s[0].length - i.length) + r);
                    if (Math.min(n, r) % 2) {
                        const t = e.slice(1, -1);
                        return {
                            type: "em",
        ...
        codespan(t) {
            ...
            if (e) {
                ...
                const n = /[^ ]/.test(t),
                    s = /^ /.test(t) && / $/.test(t);
                return n && s && (t = t.substring(1, t.length - 1)), t = l(t, !0), {
                    type: "codespan",
                    raw: e[0],
                    text: t
                }
        ...
        autolink(t, e) {
            ...
            if (n) {
                let t, s;
                return "@" === n[2] ? (t = l(this.options.mangle ? e(n[1]) : n[1]), s = "mailto:" + t) : (t = l(n[1]), s = t), {
                    type: "link",
                    raw: n[0],
                    text: t,
                    href: s,
        ...
        url(t, e) {
            ...
            if (n = this.rules.inline.url.exec(t)) {
                let t, s;
                if ("@" === n[2]) t = l(this.options.mangle ? e(n[0]) : n[0]), s = "mailto:" + t;
                else {
                    let e;
                    do {
                        e = n[0], n[0] = this.rules.inline._backpedal.exec(n[0])[0]
                    } while (e !== n[0]);
                    t = l(n[0]), s = "www." === n[1] ? "http://" + n[0] : n[0]
                }
                return {
                    type: "link",
                    raw: n[0],
    ...
    }, $.gfm.url = d($.gfm.url, "i").replace("email", $.gfm._extended_email).getRegex(), $.breaks = {
        ...$.gfm,
    ...
    class R {
        constructor(t) {
            this.tokens = [], this.tokens.links = Object.create(null), this.options = t || e, this.options.tokenizer = this.options.tokenizer || new _, this.tokenizer = this.options.tokenizer, this.tokenizer.options = this.options, this.tokenizer.lexer = this, this.inlineQueue = [], this.state = {
                inLink: !1,
                inRawBlock: !1,
                top: !0
            };
            ...
            this.options.pedantic ? (n.block = z.pedantic, n.inline = $.pedantic) : this.options.gfm && (n.block = z.gfm, this.options.breaks ? n.inline = $.breaks : n.inline = $.gfm), this.tokenizer.rules = n
        }
        static get rules() {
            return {
                block: z,
        ...
        blockTokens(t, e = []) {
            ...
            for (t = this.options.pedantic ? t.replace(/\t/g, "    ").replace(/^ +$/gm, "") : t.replace(/^( *)(\t+)/gm, ((t, e, n) => e + "    ".repeat(n.length))); t;)
                if (!(this.options.extensions && this.options.extensions.block && this.options.extensions.block.some((s => !!(n = s.call({
                        lexer: this
                    }, t, e)) && (t = t.substring(n.raw.length), e.push(n), !0)))))
                    if (n = this.tokenizer.space(t)) t = t.substring(n.raw.length), 1 === n.raw.length && e.length > 0 ? e[e.length - 1].raw += "\n" : e.push(n);
            ...
            else if (n = this.tokenizer.def(t)) t = t.substring(n.raw.length), s = e[e.length - 1], !s || "paragraph" !== s.type && "text" !== s.type ? this.tokens.links[n.tag] || (this.tokens.links[n.tag] = {
                href: n.href,
                title: n.title
                ...
                if (i = t, this.options.extensions && this.options.extensions.startBlock) {
                    ...
                    this.options.extensions.startBlock.forEach((function(t) {
                        s = t.call({
                            lexer: this
                        }, n), "number" == typeof s && s >= 0 && (e = Math.min(e, s))
                    })), e < 1 / 0 && e >= 0 && (i = t.substring(0, e + 1))
                }
                if (this.state.top && (n = this.tokenizer.paragraph(i))) s = e[e.length - 1], r && "paragraph" === s.type ? (s.raw += "\n" + n.raw, s.text += "\n" + n.text, this.inlineQueue.pop(), this.inlineQueue[this.inlineQueue.length - 1].src = s.text) : e.push(n), r = i.length !== t.length, t = t.substring(n.raw.length);
        ...
        inlineTokens(t, e = []) {
            ...
            if (this.tokens.links) {
                ...
                if (t.length > 0)
                    for (; null != (r = this.tokenizer.rules.inline.reflinkSearch.exec(l));) t.includes(r[0].slice(r[0].lastIndexOf("[") + 1, -1)) && (l = l.slice(0, r.index) + "[" + S("a", r[0].length - 2) + "]" + l.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))
            }
            for (; null != (r = this.tokenizer.rules.inline.blockSkip.exec(l));) l = l.slice(0, r.index) + "[" + S("a", r[0].length - 2) + "]" + l.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);
            for (; null != (r = this.tokenizer.rules.inline.escapedEmSt.exec(l));) l = l.slice(0, r.index + r[0].length - 2) + "++" + l.slice(this.tokenizer.rules.inline.escapedEmSt.lastIndex), this.tokenizer.rules.inline.escapedEmSt.lastIndex--;
            for (; t;)
                if (a || (o = ""), a = !1, !(this.options.extensions && this.options.extensions.inline && this.options.extensions.inline.some((s => !!(n = s.call({
                        lexer: this
                    }, t, e)) && (t = t.substring(n.raw.length), e.push(n), !0)))))
                ...
                if (n = this.tokenizer.inlineText(i, E)) t = t.substring(n.raw.length), "_" !== n.raw.slice(-1) && (o = n.raw.slice(-1)), a = !0, s = e[e.length - 1], s && "text" === s.type ? (s.raw += n.raw, s.text += n.text) : e.push(n);
                else if (t) {
                    const e = "Infinite loop on byte: " + t.charCodeAt(0);
                    if (this.options.silent) {
                        console.error(e);
    ...
    class L {
        ...
        code(t, e, n) {
            ...
            if (this.options.highlight) {
                const e = this.options.highlight(t, s);
                null != e && e !== t && (n = !0, t = e)
            }
        ...
        heading(t, e, n, s) {
            if (this.options.headerIds) {
                return `<h${e} id="${this.options.headerPrefix+s.slug(n)}">${t}</h${e}>\n`
            }
            return `<h${e}>${t}</h${e}>\n`
        }
        hr() {
    ...
    class M {
        ...
        getNextSafeSlug(t, e) {
            ...
            return e || (this.seen[t] = s, this.seen[n] = 0), n
        }
        slug(t, e = {}) {
    ...
    class C {
        constructor(t) {
            this.options = t || e, this.options.renderer = this.options.renderer || new L, this.renderer = this.options.renderer, this.renderer.options = this.options, this.textRenderer = new I, this.slugger = new M
        }
        static parse(t, e) {
        ...
        parse(t, e = !0) {
            let n, s, i, r, a, o, l, c, u, d, h, g, m, f, k, x, b, w, y, v = "";
            const S = t.length;
            for (n = 0; n < S; n++)
                if (d = t[n], this.options.extensions && this.options.extensions.renderers && this.options.extensions.renderers[d.type] && (y = this.options.extensions.renderers[d.type].call({
                        parser: this
                    }, d), !1 !== y || !["space", "hr", "heading", "code", "table", "blockquote", "list", "html", "paragraph", "text"].includes(d.type))) v += y || "";
                else switch (d.type) {
                    case "space":
                        continue;
                    case "hr":
                    ...
                    case "code":
                        ...
                        continue;
                    case "table":
                        for (c = "", l = "", r = d.header.length, s = 0; s < r; s++) l += this.renderer.tablecell(this.parseInline(d.header[s].tokens), {
                            header: !0,
                            align: d.align[s]
                        });
                        for (c += this.renderer.tablerow(l), u = "", r = d.rows.length, s = 0; s < r; s++) {
                            for (o = d.rows[s], l = "", a = o.length, i = 0; i < a; i++) l += this.renderer.tablecell(this.parseInline(o[i].tokens), {
                                header: !1,
                                align: d.align[i]
                            });
                    ...
                    case "blockquote":
                        ...
                        continue;
                    case "list":
                        for (h = d.ordered, g = d.start, m = d.loose, r = d.items.length, u = "", s = 0; s < r; s++) k = d.items[s], x = k.checked, b = k.task, f = "", k.task && (w = this.renderer.checkbox(x), m ? k.tokens.length > 0 && "paragraph" === k.tokens[0].type ? (k.tokens[0].text = w + " " + k.tokens[0].text, k.tokens[0].tokens && k.tokens[0].tokens.length > 0 && "text" === k.tokens[0].tokens[0].type && (k.tokens[0].tokens[0].text = w + " " + k.tokens[0].tokens[0].text)) : k.tokens.unshift({
                            type: "text",
                            text: w
                        }) : f += w), f += this.parse(k.tokens, m), u += this.renderer.listitem(f, b, x);
                    ...
                    case "paragraph":
                        ...
                        continue;
                    case "text":
                        for (u = d.tokens ? this.parseInline(d.tokens) : d.text; n + 1 < S && "text" === t[n + 1].type;) d = t[++n], u += "\n" + (d.tokens ? this.parseInline(d.tokens) : d.text);
        ...
        parseInline(t, e) {
            ...
            const a = t.length;
            for (n = 0; n < a; n++)
                if (s = t[n], this.options.extensions && this.options.extensions.renderers && this.options.extensions.renderers[s.type] && (i = this.options.extensions.renderers[s.type].call({
                        parser: this
                    }, s), !1 !== i || !["escape", "html", "link", "image", "strong", "em", "codespan", "br", "del", "text"].includes(s.type))) r += i || "";
                else switch (s.type) {
                    case "escape":
                    case "text":
                        r += e.text(s.text);
                    ...
                    case "html":
                        ...
                        break;
                    case "link":
                        r += e.link(s.href, s.title, this.parseInline(s.tokens, e));
                        break;
                    case "image":
                        r += e.image(s.href, s.title, s.text);
                        break;
                    case "strong":
                        r += e.strong(this.parseInline(s.tokens, e));
                        break;
                    case "em":
                        r += e.em(this.parseInline(s.tokens, e));
                        break;
                    case "codespan":
                        r += e.codespan(s.text);
                        break;
                    case "br":
                        ...
                        break;
                    case "del":
                        r += e.del(this.parseInline(s.tokens, e));
                        break;
                    default: {
    ...
    function P(t, e) {
        return (n, s, i) => {
                ...
                a = function(t, e, n) {
                    return s => {
                        if (s.message += "\nPlease report this to https://github.com/markedjs/marked.", t) {
                            const t = "<p>An error occurred:</p><pre>" + l(s.message + "", !0) + "</pre>";
            ...
            if (function(t) {
                ...
                }(s), s.hooks && (s.hooks.options = s), i) {
                const r = s.highlight;
                let o;
                try {
                    s.hooks && (n = s.hooks.preprocess(n)), o = t(n, s)
                } catch (t) {
                    return a(t)
                }
                const l = function(t) {
                    let n;
                    if (!t) try {
                        s.walkTokens && N.walkTokens(o, s.walkTokens), n = e(o, s), s.hooks && (n = s.hooks.postprocess(n))
                    } catch (e) {
                        t = e
                    }
                    return s.highlight = r, t ? a(t) : i(null, n)
                };
                if (!r || r.length < 3) return l();
                if (delete s.highlight, !o.length) return l();
                let c = 0;
                return N.walkTokens(o, (function(t) {
                    "code" === t.type && (c++, setTimeout((() => {
            ...
            if (s.async) return Promise.resolve(s.hooks ? s.hooks.preprocess(n) : n).then((e => t(e, s))).then((t => s.walkTokens ? Promise.all(N.walkTokens(t, s.walkTokens)).then((() => t)) : t)).then((t => e(t, s))).then((t => s.hooks ? s.hooks.postprocess(t) : t)).catch(a);
            try {
                s.hooks && (n = s.hooks.preprocess(n));
                const i = t(n, s);
                s.walkTokens && N.walkTokens(i, s.walkTokens);
                let r = e(i, s);
    ...
    N.options = N.setOptions = function(t) {
    ...
    }, N.getDefaults = t, N.defaults = e, N.use = function(...t) {
        ...
        t.forEach((t => {
            ...
            if (n.async = N.defaults.async || n.async || !1, t.extensions && (t.extensions.forEach((t => {
                    if (!t.name) throw new Error("extension name required");
                    if (t.renderer) {
                        const n = e.renderers[t.name];
                        e.renderers[t.name] = n ? function(...e) {
                            let s = t.renderer.apply(this, e);
                            return !1 === s && (s = n.apply(this, e)), s
                        } : t.renderer
                    }
                    if (t.tokenizer) {
                ...
                for (const n in t.renderer) {
                    const s = e[n];
                    e[n] = (...i) => {
                        let r = t.renderer[n].apply(e, i);
                        return !1 === r && (r = s.apply(e, i)), r
                    }
                }
                n.renderer = e
            }
            ...
            if (t.hooks) {
                ...
                for (const n in t.hooks) {
                    const s = e[n];
                    q.passThroughHooks.has(n) ? e[n] = i => {
                        if (N.defaults.async) return Promise.resolve(t.hooks[n].call(e, i)).then((t => s.call(e, t)));
                        const r = t.hooks[n].call(e, i);
                        return s.call(e, r)
                    } : e[n] = (...i) => {
                        let r = t.hooks[n].apply(e, i);
                        return !1 === r && (r = s.apply(e, i)), r
                    }
                }
                n.hooks = e
            ...
            if (t.walkTokens) {
                ...
                n.walkTokens = function(n) {
                    let s = [];
                    return s.push(t.walkTokens.call(this, n)), e && (s = s.concat(e.call(this, n))), s
                }
            }
            N.setOptions(n)
        }))
        ...
        let n = [];
        for (const s of t) switch (n = n.concat(e.call(N, s)), s.type) {
            case "table":
                for (const t of s.header) n = n.concat(N.walkTokens(t.tokens, e));
                for (const t of s.rows)
                    for (const s of t) n = n.concat(N.walkTokens(s.tokens, e));
                break;
            case "list":
                n = n.concat(N.walkTokens(s.items, e));
                break;
            default:
                N.defaults.extensions && N.defaults.extensions.childTokens && N.defaults.extensions.childTokens[s.type] ? N.defaults.extensions.childTokens[s.type].forEach((function(t) {
                    n = n.concat(N.walkTokens(s[t], e))
                })) : s.tokens && (n = n.concat(N.walkTokens(s.tokens, e)))
        }
        return n
    ...
    return () => {
        ...
        async function s() {
            if (n && !n.closed) n.focus();
                ...
                let notesFilePath = jsFileLocation + 'speaker-view-notes.html';
                let speaker_html_content = await leerArchivo(notesFilePath);
                if (n = window.open("about:blank", "reveal.js - Notes", "width=1100,height=700"), n.marked = N, n.document.write(speaker_html_content), !n) return void alert("Speaker view popup failed to open. Please make sure popups are allowed and reopen the speaker view.");
                ! function() {
                    const s = e.getConfig().url,
                        i = "string" == typeof s ? s : window.location.protocol + "//" + window.location.host + window.location.pathname + window.location.search;
        ...
        function i(t) {
            ...
            if (s.hasAttribute("data-notes") && (a.notes = s.getAttribute("data-notes"), a.whitespace = "pre-wrap"), r) {
                let t = r.querySelector("aside.notes");
                t ? (a.notes = t.innerHTML, a.markdown = "string" == typeof t.getAttribute("data-markdown"), i = null) : r.hasAttribute("data-notes") && (a.notes = r.getAttribute("data-notes"), a.whitespace = "pre-wrap", i = null)
            }
            i && i.length && (i = Array.from(i).filter((t => null === t.closest(".fragment"))), a.notes = i.map((t => t.innerHTML)).join("\n"), a.markdown = i[0] && "string" == typeof i[0].getAttribute("data-markdown")), n.postMessage(JSON.stringify(a), "*")
        }
        ...
        function r(s) {
            if (function(t) {
                ...
                // console.log(i);
                i && "reveal-notes" === i.namespace && "connected" === i.type ? (clearInterval(t), a()) : i && "reveal-notes" === i.namespace && "call" === i.type && function(t, s, i) {
                    let r = e[t].apply(e, s);
                    n.postMessage(JSON.stringify({
                        namespace: "reveal-notes",
                        type: "return",
        ...
        function a() {
            e.on("slidechanged", i), e.on("fragmentshown", i), e.on("fragmenthidden", i), e.on("overviewhidden", i), e.on("overviewshown", i), e.on("paused", i), e.on("resumed", i), i()
        }
        
        let config = Reveal.getConfig();
        let options = config.notes_pointer || {};
        let pointer_options = options.pointer || {};
        let notes_options = options.notes || {};
        ...
        var RevealPointer = (function() {
            ...
            function trackMouse(e) {
                ...
                point(offsetX, offsetY, isPointing);
                postPointer(offsetX, offsetY, isPointing);
            }
            ...
            addKeyBinding(pointer_options.key, pointer_options.keyCode, 'A', 'Toggle pointer', togglePointer);
        ...
        return {
            id: "notes",
            init: function(t) {
                e = t, /receiver/i.test(window.location.search) || (null !== window.location.search.match(/(\?|\&)notes/gi) ? s() : window.addEventListener("message", (t => {
                    if (!n && "string" == typeof t.data) {
                        ...
                        s && "reveal-notes" === s.namespace && "heartbeat" === s.type && (e = t.source, n && !n.closed ? n.focus() : (n = e, window.addEventListener("message", r), a()))
                    }
                    var e
                })),
                addKeyBinding(
                    notes_options.key,
                    notes_options.keyCode,
                    'S',
                    'Speaker notes view',
                    function() { s(); }
                ),
                e.point = RevealPointer.point,
                e['point'] = RevealPointer.point
                // e.addKeyBinding({
                //     keyCode: 83,
                //     key: "S",
