...
var RevealNotes = (function() {
    ...
    async function openNotes( notesFilePath ) {
        ...
        if( !notesFilePath ) {
            ...
            notesFilePath = jsFileLocation + 'speaker-view-pointer.html';
        }
        let notesContent = await leerArchivo(notesFilePath);

        notesPopup = window.open("about:blank", 'reveal.js - Notes', 'width=1100,height=700' );
        notesPopup.document.write(notesContent);
